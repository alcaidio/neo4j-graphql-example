...
const debug = debug_1.default(constants_1.DEBUG_INFER_SCHEMA);
function createNodeFields(propertyRows, elementType) {
    ...
    propertyRows.forEach((propertyRow) => {
        ...
        out.push(new NodeField_1.NodeField(propertyRow.name, map_neo4j_to_graphql_type_1.default(propertyRow.types, propertyRow.mandatory)));
    });
    return out;
}
