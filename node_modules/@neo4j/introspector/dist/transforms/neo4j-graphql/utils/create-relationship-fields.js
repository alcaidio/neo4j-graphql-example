...
function createRelationshipFields(fromTypeName, toTypeName, relType, propertiesTypeName) {
    const fromField = new NodeField_1.NodeField(generate_relationship_field_name_1.default(relType, fromTypeName, toTypeName, "OUT"), `[${toTypeName}!]!`);
    ...
    const toField = new NodeField_1.NodeField(generate_relationship_field_name_1.default(relType, fromTypeName, toTypeName, "IN"), `[${fromTypeName}!]!`);
